...
//   templateUrl: 'my-pdf-viewer.html',
//   styles: [`
// .ng2-pdf-viewer--zoom {
//   overflow-x: scroll;
// }
...
//     let loadingTask: any = PDFJS.getDocument(<PDFSource>this.src);
...
//     let container = this.element.nativeElement.querySelector('#pdf-content');
